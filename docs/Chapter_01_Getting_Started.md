...
- Click **💾 Save Game** in the top toolbar (or press `Ctrl+S` / `Cmd+S`).
- Studio saves your project state into the local workspace storage.
...
- [ ] Save your project using **💾 Save Game**.
