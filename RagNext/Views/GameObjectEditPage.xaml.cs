...
namespace RagNext.Views
{
    ...
    public partial class GameObjectEditPage : ContentPage
    {
        ...
        private async void OnGeneratePortraitClicked(object? sender, EventArgs e)
        {
            ...
            var prompt = await DisplayPromptAsync("Generate Portrait", "Enter a prompt for the image:", "Generate", "Cancel", placeholder: "cool fantasy weapon or ancient artifact item");
